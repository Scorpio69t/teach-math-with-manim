...
> Teach Math with Manim — 图书《用 Manim 讲好数学》官方配套开源仓库

本仓库是图书《用 Manim 讲好数学：AI 时代的教学动画设计与实战》的配套资源，包含书中全部 **60+ 教学动画案例的完整源码**、**自研 Manim 教学动画 AI Skill**，以及可直接复用的模板与工具脚本。全部内容以 MIT 协议开源，欢迎教师、学生和科普创作者自由取用。
